...
model = tf.keras.models.load_model('model.keras')  # Load the model in h5 format
...
## Encode Gender (VERY IMPORTANT FIX)
...
if prediction_proba > 0.5:
    ...
    st.write(f"The customer is  not likely to churn with a probability of {prediction_proba:.2f}")
